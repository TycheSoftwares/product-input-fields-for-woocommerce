	...
	class Pif_Tracking_Functions {
		...
		public static function pif_get_all_product_fields() {
			...
			for ( $i = 1; $i <= $input_counts; $i++ ) {
				$args = array(
					'alg_wc_pif_enabled_global_' . $i     => get_option( 'enabled_global_' . $i ),
					'alg_wc_pif_type_global_' . $i        => get_option( 'type_global_' . $i ),
					'alg_wc_pif_required_global_' . $i    => get_option( 'required_global_' . $i ),
					'alg_wc_pif_title_global_' . $i       => get_option( 'title_global_' . $i ),
					'alg_wc_pif_placeholder_global_' . $i => get_option( 'placeholder_global_' . $i ),
					'alg_wc_pif_default_value_global_' . $i => get_option( 'default_value_global_' . $i ),
					'alg_wc_pif_class_global_' . $i       => get_option( 'class_global_' . $i ),
					'alg_wc_pif_style_global_' . $i       => get_option( 'style_global_' . $i ),
					'alg_wc_pif_required_message_global_' . $i => get_option( 'required_message_global_' . $i ),
					'alg_wc_pif_input_restrictions_min_global_' . $i => get_option( 'input_restrictions_min_global_' . $i ),
					'alg_wc_pif_input_restrictions_max_global_' . $i => get_option( 'input_restrictions_max_global_' . $i ),
					'alg_wc_pif_input_restrictions_step_global_' . $i => get_option( 'input_restrictions_step_global_' . $i ),
					'alg_wc_pif_input_restrictions_maxlength_global_' . $i => get_option( 'input_restrictions_maxlength_global_' . $i ),
					'alg_wc_pif_input_restrictions_pattern_global_' . $i => get_option( 'input_restrictions_pattern_global_' . $i ),
					'alg_wc_pif_type_checkbox_yes_global_' . $i => get_option( 'type_checkbox_yes_global_' . $i ),
					'alg_wc_pif_type_checkbox_no_global_' . $i => get_option( 'type_checkbox_no_global_' . $i ),
					'alg_wc_pif_type_file_accept_global_' . $i => get_option( 'type_file_accept_global_' . $i ),
					'alg_wc_pif_type_file_wrong_type_msg_global_' . $i => get_option( 'type_file_wrong_type_msg_global_' . $i ),
					'alg_wc_pif_type_file_max_size_global_' . $i => get_option( 'type_file_max_size_global_' . $i ),
					'alg_wc_pif_type_file_max_size_msg_global_' . $i => get_option( 'type_file_max_size_msg_global_' . $i ),
					'alg_wc_pif_type_datepicker_format_global_' . $i => get_option( 'type_datepicker_format_global_' . $i ),
					'alg_wc_pif_type_datepicker_mindate_global_' . $i => get_option( 'type_datepicker_mindate_global_' . $i ),
					'alg_wc_pif_type_datepicker_maxdate_global_' . $i => get_option( 'type_datepicker_maxdate_global_' . $i ),
					'alg_wc_pif_type_datepicker_addyear_global_' . $i => get_option( 'type_datepicker_addyear_global_' . $i ),
					'alg_wc_pif_type_datepicker_yearrange_global_' . $i => get_option( 'type_datepicker_yearrange_global_' . $i ),
					'alg_wc_pif_type_datepicker_firstday_global_' . $i => get_option( 'type_datepicker_firstday_global_' . $i ),
					'alg_wc_pif_type_timepicker_format_global_' . $i => get_option( 'type_timepicker_format_global_' . $i ),
					'alg_wc_pif_type_timepicker_interval_global_' . $i => get_option( 'type_timepicker_interval_global_' . $i ),
					'alg_wc_pif_type_color_allow_typing_global_' . $i => get_option( 'type_color_allow_typing_global_' . $i ),
					'alg_wc_pif_select_radio_option_type_global_' . $i => get_option( 'select_radio_option_type_global_' . $i ),
				);
